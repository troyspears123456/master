...
class ThighScreen extends StatefulWidget {
  const ThighScreen({Key? key}) : super(key: key);

  @override
  _ThighScreenState createState() => _ThighScreenState();
}

class _ThighScreenState extends State<ThighScreen> {
